# Grafana MCP Observability Integration

This repository is a technical implementation for observability with OpenTelemetry, Prometheus, Grafana, Loki, Tempo and MCP-based access to telemetry.
